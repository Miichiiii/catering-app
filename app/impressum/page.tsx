    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-4xl mx-auto px-4 py-16 md:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none space-y-8">
          <section>
            <h2 className="text-2xl font-semibold mb-4">Shemesh Restaurant & Bar</h2>
            <p className="mb-2">Istam Baraeva</p>
            <p className="mb-2">Grafenberger Allee 277</p>
            <p className="mb-2">40237 Düsseldorf</p>
            <p className="mb-2">
              Tel:{" "}
              <a href="tel:01751770787" className="text-primary hover:underline">
                0175 177 0787
              </a>
            </p>
            <p className="mb-2">
              Tel:{" "}
              <a href="tel:021123942900" className="text-primary hover:underline">
                0211 239 42900
              </a>
            </p>
            <p>
              E-Mail:{" "}
              <a href="mailto:info@shemesh-restaurant.de" className="text-primary hover:underline">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4">Disclaimer - rechtliche Hinweise</h2>
            
            <h3 className="text-xl font-semibold mb-3 mt-6">Auskunfts- und Widerrufsrecht</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-6">Datenschutz (allgemein)</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-6">Datenschutzerklärung Facebook-Plugins (Like/ Gefällt mir-Button etc.)</h3>
            <p className="mb-4">
              Auf dieser Website sind Plugins des Social-Media-Anbieters Facebook.com (für Europa: Facebook Irland Limited, 4 Grand Canal Square, Dublin 2, Ireland; für die USA: Facebook Inc., 1601 Willow Road, Menlo Park, CA 94025, USA), implementiert. Eine Übersicht der Facebook-Plugins finden Sie hier:{" "}
              <a href="https://developers.facebook.com/docs/plugins/" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">
            ...
            <p className="mb-4">
              Durch Anklicken der Facebook-Plugins gelangen Sie zum Login-Bereich von Facebook. Bereits eingeloggte Facebook-Nutzer können sofort Inhalte unserer Website auf ihren Facebook-Profilen veröffentlichen. Infolge der Nutzung dieser Plugins kann Facebook den Besuch unserer Website Ihrem persönlichen Benutzerkonto zuordnen. Wir weisen ausdrücklich darauf hin, dass wir als Anbieter dieser Internetseiten keine Kenntnis vom Inhalt der übermittelten Daten sowie deren Nutzung durch Facebook erhalten. Weitere Informationen zum Datenschutz durch Facebook erhalten Sie unter:{" "}
              <a href="https://de-de.facebook.com/policy.php" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4">Disclaimer (Haftungsausschluss)</h2>
            
            <h3 className="text-xl font-semibold mb-3 mt-6">1. Haftung für Inhalte</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-6">2. Haftung für Links</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-6">3. Urheberrecht</h3>
            <p className="mb-4">
