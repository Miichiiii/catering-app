        ...
        <div className="prose prose-lg max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="mb-4">
              ...
              Einstellungsinformationen auf dem Endgerät des Nutzers abgelegt,
              sodass bei einem weiteren Besuch die Abfrage in Bezug auf die
              Einwilligung nicht erfolgen muss.
            </p>
            <p className="mb-6">
              Das Cookie ist erforderlich um eine rechtskonforme Einwilligung
              des Nutzers einzuholen. Die Installation der Cookies kann der
              Nutzer durch Einstellungen seines Browsers verhindern bzw.
              beenden.
            </p>
            ...
            <p className="mb-6">
              ...
              zusammenarbeiten, verwendet. Die Einzelheiten hierzu, insbesondere
              zu den Zwecken und den Rechtsgrundlagen der Verarbeitung solcher
            ...
            <p className="mb-4">
              Falls Sie sich für unseren kostenlosen Newsletter anmelden, werden
              die von Ihnen hierzu abgefragten Daten, also Ihre E-Mail-Adresse
              sowie – optional – Ihr Name und Ihre Anschrift, an uns
              ...
              weiteren Anmeldevorgangs werden wir Ihre Einwilligung in die
              Übersendung des Newsletters einholen, den Inhalt konkret
            ...
            <p className="mb-4">
              ...
              geregelt. Diese Vereinbarung ist unter folgendem Link abrufbar:{" "}
              <a
            ...
            <p className="mb-4">
              Weitere Informationen finden Sie in der Datenrichtlinie von
              Facebook:{" "}
              <a
            ...
            <p className="mb-4">
              ...
              Darstellung externer Schriftarten ein. Es handelt sich hierbei um
            ...
            <p className="mb-4">
              Die Nutzung von Google Maps sowie der über Google Maps erlangten
              Informationen erfolgt nach den{" "}
              <a
